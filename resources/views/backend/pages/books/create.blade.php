        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('book-sharing.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="quantity" class="form-control" id="exampleInputEmailQuantity" aria-describedby="emailHelp" value="1" required min="1">
                                </div>
                                <div class="form-group col-md-6">
