        ...
        <div class="row">
            <div class="col-md-12 my-5">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.book.update',$book->slug) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="quantity" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $book->quantity }}" >
                                </div>
