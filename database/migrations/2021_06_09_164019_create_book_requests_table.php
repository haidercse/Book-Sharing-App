...
class CreateBookRequestsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('book_requests', function (Blueprint $table) {
            ...
            $table->unsignedTinyInteger('status')->default(1)->comment("1=>requested; 2=>owner_confirm; 3=>Owner_rejected; 4=>user_confirm; 5=>user_reject; 6=>user_return; 7=>return_confirm");
